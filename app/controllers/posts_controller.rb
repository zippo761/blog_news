class PostsController < ApplicationController
  ...
  def edit
    ...
    currently_editing(current_user.id, user_name) if @post.current_editor.nil? # TODO if user click on cancel => unset current editor
  end
  ...
  def currently_editing(editor, user_name = current_user.name)
    # set current editor #when user vitsit edit
